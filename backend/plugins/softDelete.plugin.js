...
export default function softDeletePlugin(schema, options = {}) {
    ...
    schema.statics.softDeleteOne = async function (query, options = {}) {
        ...
        if (res.modifiedCount > 0) {
            await createAuditRecord(this.modelName, doc._id, 'SOFT_DELETE', options.userId, options.reason, doc.toObject(), options.session);
    ...
    schema.statics.restoreOne = async function (query, options = {}) {
        ...
        if (res.modifiedCount > 0) {
            await createAuditRecord(this.modelName, doc._id, 'RESTORE', options.userId, options.reason, doc.toObject(), options.session);
