...
import { getDeals, matchDeals, getDealById, addDeal, updateDeal, deleteDeal, bulkDeleteDeals, importDeals, closeDeal, getUniqueBlocks, sanitizeDeal, addOffer } from "../controllers/deal.controller.js";
...
router.route('/')
    .get(getDeals)
    .post(validateBusinessRules('deals'), addDeal);
