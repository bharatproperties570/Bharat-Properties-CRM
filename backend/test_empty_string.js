        ...
        components: [
            {
                ...
                parameters: [
                    ...
                    { type: 'text', text: '', parameter_name: 'preferred_area' }, // EMPTY STRING!
                    { type: 'text', text: '', parameter_name: 'preferred_city' }, // EMPTY STRING!
            ...
            { type: 'button', sub_type: 'url', index: '0', parameters: [{ type: 'text', text: 'visit' }] },
            { type: 'button', sub_type: 'url', index: '1', parameters: [{ type: 'text', text: 'visit' }] }
        ]
    }
};

axios.post(`https://graph.facebook.com/v19.0/${phoneId}/messages`, payload, { headers: { 'Authorization': `Bearer ${token}` }})
