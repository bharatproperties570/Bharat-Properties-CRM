...
const ContactBookings = ({ expandedSections, toggleSection, contactBookings, renderValue, renderLookup, onNavigate }) => {
    ...
    return (
        <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid var(--border-color)', overflow: 'hidden', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
            <div 
            ...
            >
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <i className="fas fa-file-contract" style={{ color: 'var(--premium-blue)', fontSize: '1rem' }}></i>
                    ...
                    {contactBookings && contactBookings.length > 0 ? (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                            {contactBookings.map((booking) => {
                                ...
                                return (
                                    <div key={booking._id} style={{ padding: '12px', border: '1px solid #e2e8f0', borderRadius: '12px', background: '#f8fafc' }}>
                        ...
                        <div style={{ padding: '20px', textAlign: 'center', color: '#94a3b8', fontSize: '0.8rem', background: '#f8fafc', borderRadius: '12px', border: '1px dashed #cbd5e1' }}>
