        ...
        <div className="glass-card" style={{ borderRadius: '16px', border: '1px solid rgba(16, 185, 129, 0.3)', boxShadow: '0 8px 32px 0 rgba(16, 185, 129, 0.08)' }}>
            ...
            {expandedSections.includes('property_req') && (
                <div style={{ padding: '20px 16px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    ...
                    <div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '24px' }}>
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: '0.85rem', fontWeight: 600, color: isDark ? 'var(--text-muted)' : '#475569', wordBreak: 'break-word' }}>{aiStats.preferences.subType?.join(', ') || '-'}</div>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: '0.85rem', fontWeight: 600, color: isDark ? 'var(--text-muted)' : '#475569', wordBreak: 'break-word' }}>{aiStats.preferences.unitType?.join(', ') || '-'}</div>
                            </div>
                            <div>
                    ...
                    <div style={{ height: '1px', background: isDark ? 'rgba(255, 255, 255, 0.03)' : '#f1f5f9', margin: '8px 0' }}></div>
                    ...
                    <div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '24px' }}>
                            ...
                            <div>
                                ...
                                <span className="pill" style={{ background: isDark ? 'rgba(255, 255, 255, 0.03)' : '#fff7ed', color: '#9a3412', fontSize: '0.7rem', fontWeight: 800 }}>{aiStats.preferences.urgency?.toUpperCase() || 'NORMAL'}</span>
                            </div>
