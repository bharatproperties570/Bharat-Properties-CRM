            ...
            {rounds.length > 0 ? (
                <TableContainer>
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                        <thead>
                            <tr style={{ background: isDark ? 'rgba(255, 255, 255, 0.03)' : '#f8fafc', borderBottom: isDark ? '1px solid rgba(255, 255, 255, 0.1)' : '1px solid #e2e8f0' }}>
                                ...
                                <tr key={idx} style={{ borderBottom: isDark ? '1px solid rgba(255, 255, 255, 0.1)' : '1px solid #f1f5f9' }}>
                                    ...
                                    <td style={tdStyle}>
                                        <span style={{
                                            ...
                                            background: isDark ? 'rgba(255, 255, 255, 0.03)' : '#f0fdf4', color: '#166534', border: '1px solid #dcfce7', textTransform: 'uppercase'
                                        }} title={round.notes}>
                                            {round.status || 'Active'}
                                        </span>
                                    </td>
...
export const CommissionDetails = ({ commission = {} }) => {
    ...
    return (
        <div style={{ background: isDark ? 'rgba(255, 255, 255, 0.03)' : '#fff', borderRadius: '16px', border: isDark ? '1px solid rgba(255, 255, 255, 0.1)' : '1px solid #e2e8f0', overflow: 'hidden' }}>
            <div style={{ padding: '24px', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '24px', background: isDark ? 'rgba(255, 255, 255, 0.03)' : '#f8fafc', borderBottom: isDark ? '1px solid rgba(255, 255, 255, 0.1)' : '1px solid #e2e8f0' }}>
                <div>
                    <span style={{ display: 'block', fontSize: '0.65rem', fontWeight: 800, color: isDark ? 'var(--text-muted)' : '#64748b', textTransform: 'uppercase', marginBottom: '4px' }}>Expected Commission</span>
                    <span style={{ fontSize: '1.2rem', fontWeight: 900, color: '#10b981' }}>{formatIndianCurrency(commission.expectedAmount || 0)}</span>
                </div>
                <div>
                    <span style={{ display: 'block', fontSize: '0.65rem', fontWeight: 800, color: isDark ? 'var(--text-muted)' : '#64748b', textTransform: 'uppercase', marginBottom: '4px' }}>Status</span>
            ...
            <TableContainer>
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead>
                        <tr style={{ background: isDark ? 'rgba(255, 255, 255, 0.03)' : '#fff', borderBottom: isDark ? '1px solid rgba(255, 255, 255, 0.1)' : '1px solid #f1f5f9' }}>
                            ...
                            <tr key={idx} style={{ borderBottom: isDark ? '1px solid rgba(255, 255, 255, 0.1)' : '1px solid #f1f5f9' }}>
                                <td style={tdStyle}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                        <div style={{ width: '32px', height: '32px', background: isDark ? 'rgba(255, 255, 255, 0.03)' : '#e0e7ff', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
...
export const CostSheet = ({ financials, deal }) => {
    const { isDark } = useTheme();
    return (
<div style={{ background: isDark ? 'rgba(255, 255, 255, 0.03)' : '#fff', borderRadius: '16px', overflow: 'hidden', border: isDark ? '1px solid rgba(255, 255, 255, 0.1)' : '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)' }}>
        ...
        <div style={{ padding: '32px' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                    <tr style={{ borderBottom: isDark ? '1px solid rgba(255, 255, 255, 0.1)' : '2px solid #e2e8f0' }}>
                        <th style={{ textAlign: 'left', padding: '12px 0', color: isDark ? 'var(--text-muted)' : '#64748b', fontSize: '0.8rem', textTransform: 'uppercase' }}>Description</th>
                        <th style={{ textAlign: 'right', padding: '12px 0', color: isDark ? 'var(--text-muted)' : '#64748b', fontSize: '0.8rem', textTransform: 'uppercase' }}>Amount (₹)</th>
                    </tr>
                </thead>
                <tbody>
        ...
        <div style={{ background: isDark ? 'rgba(255, 255, 255, 0.03)' : '#f1f5f9', padding: '16px 32px', textAlign: 'center', fontSize: '0.75rem', color: '#94a3b8' }}>
