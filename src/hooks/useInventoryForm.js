    ...
    useEffect(() => {
        if (property && isOpen) {
            ...
            setFormData(prev => ({
                ...
                zoneName: property.zoneName ? (property.zoneName._id || property.zoneName.id || property.zoneName) : '',
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const transformedData = {
                ...
                zoneName: getLookupId('ZoneName', payload.zoneName) || payload.zoneName,
