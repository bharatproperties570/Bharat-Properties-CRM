...
export const useStageEngine = () => {
    ...
    const triggerStageUpdate = useCallback(async (
        ...
        const { stage: newStage, requiredForm } = computeStage(
            activityType,
            purpose,
            outcome,
            stageMappingRules || [],
        ...
        try {
            ...
            return { stage: newStage, success: false, error: err.message, requiredForm };
        }
        ...
        return { stage: newStage, success: updateSuccess, blocked: false, requiredForm };
    }, [activityMasterFields, stageMappingRules, syncDealStage]);
