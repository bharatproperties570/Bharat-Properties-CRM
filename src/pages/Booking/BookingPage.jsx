                    ...
                    <body>
                        ...
                        <div class="grid-2">
                            <div class="box">
                                ...
                                <div class="row"><span class="label">Address:</span> <span class="val" style="font-weight: normal; font-size: 13px; line-height: 1.3;">${sellerAddress || '___________________________'}</span></div>
                            </div>
                            <div class="box">
                                ...
                                <div class="row"><span class="label">Address:</span> <span class="val" style="font-weight: normal; font-size: 13px; line-height: 1.3;">${buyerAddress || '___________________________'}</span></div>
                            </div>
                        </div>
                        ...
                        <div class="box" style="margin-bottom: 20px; background: #f0fdf4; border-color: #86efac;">
                            ...
                            <div style="font-size: 15px; line-height: 1.8; color: #166534; text-align: justify;">
                                Received a sum of <strong>${tokenAnko}</strong>/- (<strong>${tokenWords}</strong>) by <strong>${tokenMode} ___________________</strong> on dated <strong>${tokenDate}</strong> as an advance Payment against the sale of my above said property.
                            </div>
                        </div>
