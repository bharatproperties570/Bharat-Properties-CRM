...
const LocationDetailsCard = ({ inventory, getLookupValue, onUpdateLocation }) => {
    ...
    // Fallback to MAP_CENTER for the map view, but only show marker if valid
        ...
        <div className="glass-card">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(380px, 450px) 1fr', gap: '32px' }}>
                ...
                <div style={{ height: '100%', borderRadius: '24px', overflow: 'hidden', border: '1px solid #e2e8f0', position: 'relative', boxShadow: '0 8px 30px rgba(0,0,0,0.06)' }}>
                    ...
                    {/* Professional Map Overlay: Update & Verified Status */}
                    <div style={{
                    ...
                    <div style={{
                        ...
                        <i className="fas fa-satellite" style={{ color: 'var(--premium-blue)' }}></i>
                        Interactive Map
                    </div>
                </div>
            </div>
