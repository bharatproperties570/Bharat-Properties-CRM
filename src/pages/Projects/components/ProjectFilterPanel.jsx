        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 2000, display: 'flex', justifyContent: 'flex-end', fontFamily: "'Inter', sans-serif" }}>
            ...
            <div style={{
                ...
                <header style={{ padding: '20px 24px', borderBottom: '1px solid var(--border-color)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: isDark ? '#1e293b' : '#ffffff' }}>
                    <div>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--text-main)', letterSpacing: '-0.025em', margin: 0 }}>Filter Projects</h2>
                                ...
                                return (
                                    <button
                                        ...
                                        style={{
                                            ...
                                            transition: 'all 0.2s', ...(isActive ? { backgroundColor: isDark ? 'rgba(59, 130, 246, 0.15)' : '#eff6ff', borderColor: isDark ? '#60a5fa' : '#0066ff', color: isDark ? '#60a5fa' : '#0066ff' } : { backgroundColor: isDark ? '#1e293b' : '#ffffff', borderColor: 'var(--border-color)', color: 'var(--text-muted)' })
                                        }}
                                    >
                                        {renderValue(status)}
                                    </button>
