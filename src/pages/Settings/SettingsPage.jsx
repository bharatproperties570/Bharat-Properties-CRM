...
import DealCaptureSettingsPage from './views/DealCaptureSettingsPage';
                        ...
                        {filteredUsers.map((user, index) => {
                            ...
                            return (
                                <tr key={user._id || user.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                                    ...
                                    <td style={{ padding: '16px', fontWeight: 700 }}>{renderValue(user.designation) || user.role?.name || '-'}</td>
        ...
        <section id="settingsHubView" className="view-section active" style={{ display: 'flex', flexDirection: 'row', overflow: 'hidden', height: '100%', flex: 1, position: 'relative' }}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: 'var(--bg-card)', overflow: 'hidden' }}>
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                    ...
                    ) : activeTab === 'deal-capture' ? (
                        <DealCaptureSettingsPage />
