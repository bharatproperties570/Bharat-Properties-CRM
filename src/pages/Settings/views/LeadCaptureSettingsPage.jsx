    ...
    return (
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: 'var(--bg-card)' }}>
            ...
            <div style={{ padding: '32px 40px', borderBottom: '1px solid #f1f5f9', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                    <h2 style={{ margin: 0, fontSize: '1.5rem', fontWeight: 800, color: 'var(--text-main)' }}>LEAD CAPTURE FORMS</h2>
                    <p style={{ margin: '8px 0 0', color: 'var(--text-muted)', fontSize: '0.9rem' }}>Build intelligent forms to capture and qualify leads automatically.</p>
                </div>
                <button
            ...
            <div style={{ flex: 1, padding: '40px', overflowY: 'auto' }}>
                {isLoading ? (
                    ...
                    <div style={{ textAlign: 'center', padding: '100px', background: 'var(--bg-light)', borderRadius: '24px', border: '2px dashed #e2e8f0' }}>
                        ...
                        <h3 style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--text-main)', marginBottom: '8px' }}>No Forms Created Yet</h3>
                        <p style={{ color: 'var(--text-muted)', maxWidth: '400px', margin: '0 auto 24px' }}>Start building your first lead capture form to automate your prospecting workflow.</p>
                        <button
                            onClick={handleCreateNew}
                            ...
                            <div key={form._id} style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color)', borderRadius: '20px', overflow: 'hidden', transition: 'all 0.3s ease', position: 'relative' }}>
                                <div style={{ padding: '24px' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
                                        <div style={{ fontSize: '0.7rem', fontWeight: 800, color: form.isActive ? '#10b981' : 'var(--text-muted)', background: form.isActive ? '#10b98115' : 'var(--bg-light)', padding: '4px 8px', borderRadius: '6px' }}>
                                    ...
                                    <p style={{ fontSize: '0.85rem', color: 'var(--primary-color)', fontWeight: 600, marginTop: '4px', background: 'var(--stat-property-bg)', padding: '4px 10px', borderRadius: '6px', display: 'inline-block' }}>/public/form/{form.slug}</p>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '12px', marginTop: '24px', padding: '16px', background: 'var(--bg-light)', borderRadius: '12px' }}>
                                        ...
                                        <div style={{ textAlign: 'center', borderLeft: '1px solid var(--border-color)', borderRight: '1px solid var(--border-color)' }}>
                                            <div style={{ fontSize: '0.7rem', fontWeight: 800, color: 'var(--text-muted)', textTransform: 'uppercase' }}>Leads</div>
